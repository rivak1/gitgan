			...
			<div class="col-md-6 formPart">
				...
				<div class="container">
				  <form:form modelAttribute="employeeRegister">
				    <form:errors path="${registerFailed}" class="error" />
				    ...
				    <div class="form-group">
						...
						<form:password path="password" cssClass="form-control" id="password" placeholder="Enter Your Name" />
						<form:errors cssClass="error text-danger" path="password"/> 
					 </div>
				     <div class="form-group">
						<form:label path="confirmPassword">Confirm Password:</form:label> 
						<form:password path="confirmPassword" cssClass="form-control" id="confirmPassword" placeholder="Enter Your Name" />
						<form:errors cssClass="error text-danger" path="confirmPassword"/> 
					 </div>
				    <div class="form-group">
						<form:label path="mobileNumber">Mobile Number</form:label> 
						<form:input path="mobileNumber" cssClass="form-control" id="mobileNumber" placeholder="Enter Your Name" />
